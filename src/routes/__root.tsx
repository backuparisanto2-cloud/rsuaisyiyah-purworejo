...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://rsuaisyiyah-purworejo.lovable.app/og-image.png" },
      { name: "twitter:image", content: "https://rsuaisyiyah-purworejo.lovable.app/og-image.png" },
