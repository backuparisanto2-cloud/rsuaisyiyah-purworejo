    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => setMultiImport(true)} data-tour="dokter-import"><Sparkles className="h-4 w-4 mr-1" />Import Multi-Dokter (AI)</Button>
          <Button onClick={() => setEditing({ ...emptyDoctor, display_order: doctors.length + 1 })} data-tour="dokter-add"><Plus className="h-4 w-4 mr-1" />Tambah Dokter</Button>
